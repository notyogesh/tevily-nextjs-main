...
const whyChoose = {
  bg: "/why-choose-left-bg.jpg",
  bg2,
  toggleText: " Trips \n & tours",
  title: "Why Choose Make Your Vacations",
  tagline: "Our benefit lists",
  description:
    " We offer trusted travel services backed by industry expertise and customer-first values, ensuring every journey is smooth, safe, and unforgettable.",
